...
if(isset($_GET['g']) && isset($_GET['u']) && isset($_GET['o'])){
    ...
    $advice = $validate->category_description_validate($validate->item_validate($_GET['adv']))   ;
    ...
    try
     {
                    ...
                    $sql = "INSERT INTO goals.".$o."_adv "
                            . "(goal_id, user_id, owner_id, adv_comment, date_added, last_edited, status) "
                            . "VALUES( :g, :u, :o, :a, NOW(), NOW(), 'ACTIVE' )";
