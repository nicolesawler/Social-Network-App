...
<div id="career-box-holder">
	...
	<div id="career-box-top-left" class="career-box-top-left">
		...
		<div id="career-survey-question">
			...
			<option <?=$userPref['e_qualified'] == 'Yes' ? 'selected ' : '';?>value="Yes">Yes, I am qualified</option>
			<option <?=$userPref['e_qualified'] == 'No' ? 'selected ' : '';?>value="No">No, but want to be</option>
...
<button type="submit" name="btn_career_save" class="save-career" id="save-career" <?=$saved == 'savesuccess' ? ' disabled ' : '';?>>Save</button>
<div class="clear"></div>
</form>	
