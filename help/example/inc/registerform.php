...
<div class="form-group">
	<input type="email" name="username" id="email" tabindex="1" class="form-control" placeholder="Username" value="">
</div>
...
<select id="in-birth-day" name="txt_day" value="<?php if(isset($error)){echo $day;}?>">
...
<select id="in-birth-year" name="txt_year" value="<?php if(isset($error)){echo $year;}?>">
