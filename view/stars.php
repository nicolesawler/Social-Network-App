...
require 'checkUsername.php';
        ...
        if(USER_PROFILE_ID != 0){
                             ...
                             try
                                {
                              if($getZ = $userProfile->getZodiac($_SESSION['zodiac'])) 
                                      {
...
<div id="stars-box-holder">
	...
	<div id="stars-box-top-left" class="stars-box-top-left">
                ...
                <br>
Standardizing the way we see resumes</strong> - Tell employers what you want at your organization. You spend a good portion of your life at your job, make sure you're doing something yoStandardizing the way we see resumes</strong> - Tell employers what you want at your organization. 
        <div class="clear"></div>
...
<div id="stars-box-holder">
	...
	<div id="stars-box-top-right" class="stars-box-top-right">
            <form method="post">
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Aquarius" type="submit">Aquarius</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Aries" type="submit">Aries</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Cancer" type="submit">Cancer</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Capricorn" type="submit">Capricorn</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Gemini" type="submit">Gemini</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Libra" type="submit">Libra</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Leo" type="submit">Leo</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Pisces" type="submit">Pisces</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Sagittarius" type="submit">Sagittarius</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Scorpio" type="submit">Scorpio</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Taurus" type="submit">Taurus</button>
                <button class="btn-stars-zodiac" name="btn-stars-zodiac" value="Virgo" type="submit">Virgo</button>
        </form>
	</div>
</div>
<div class="clear"></div>
